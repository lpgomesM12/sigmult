...
class FornecedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fornecedor" do
    assert_difference('Fornecedor.count') do
      post fornecedors_url, params: { fornecedor: { desc_cnpj: @fornecedor.desc_cnpj, empresa_id: @fornecedor.empresa_id, endereco_id: @fornecedor.endereco_id, nome_fornecedor: @fornecedor.nome_fornecedor } }
    end
  ...
  test "should update fornecedor" do
    patch fornecedor_url(@fornecedor), params: { fornecedor: { desc_cnpj: @fornecedor.desc_cnpj, empresa_id: @fornecedor.empresa_id, endereco_id: @fornecedor.endereco_id, nome_fornecedor: @fornecedor.nome_fornecedor } }
