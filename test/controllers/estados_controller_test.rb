...
class EstadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estado" do
    assert_difference('Estado.count') do
      post estados_url, params: { estado: { flag_ativo: @estado.flag_ativo, nome_estado: @estado.nome_estado, sigl_estado: @estado.sigl_estado } }
    end
  ...
  test "should update estado" do
    patch estado_url(@estado), params: { estado: { flag_ativo: @estado.flag_ativo, nome_estado: @estado.nome_estado, sigl_estado: @estado.sigl_estado } }
