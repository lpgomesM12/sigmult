...
class EnderecosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post enderecos_url, params: { endereco: { cep: @endereco.cep, cidade_id: @endereco.cidade_id, complemento: @endereco.complemento, endereco: @endereco.endereco } }
    end
  ...
  test "should update endereco" do
    patch endereco_url(@endereco), params: { endereco: { cep: @endereco.cep, cidade_id: @endereco.cidade_id, complemento: @endereco.complemento, endereco: @endereco.endereco } }
