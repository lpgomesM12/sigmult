...
class CaixasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create caixa" do
    assert_difference('Caixa.count') do
      post caixas_url, params: { caixa: { data_abertura: @caixa.data_abertura, data_fechamento: @caixa.data_fechamento, valr_caixa: @caixa.valr_caixa } }
    end
  ...
  test "should update caixa" do
    patch caixa_url(@caixa), params: { caixa: { data_abertura: @caixa.data_abertura, data_fechamento: @caixa.data_fechamento, valr_caixa: @caixa.valr_caixa } }
