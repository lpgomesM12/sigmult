...
class CidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cidade" do
    assert_difference('Cidade.count') do
      post cidades_url, params: { cidade: { estado_id: @cidade.estado_id, flag_ativo: @cidade.flag_ativo, nome_cidade: @cidade.nome_cidade } }
    end
  ...
  test "should update cidade" do
    patch cidade_url(@cidade), params: { cidade: { estado_id: @cidade.estado_id, flag_ativo: @cidade.flag_ativo, nome_cidade: @cidade.nome_cidade } }
